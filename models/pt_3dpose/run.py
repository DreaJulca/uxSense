...
if args.render:
    ...
    coord_file1 = args.viz_video.replace(".mp4", "/3d_keypoints.json")
    with open(coord_file1, 'w') as f:
        f.write(str(json.dumps(input_keypoints.tolist())))
    ...
    if args.viz_export is not None:
        ...
        coord_file0 = args.viz_video.replace(".mp4", "/3d_pose_coordinates.json")
        with open(coord_file0, 'w') as f:
            f.write(str(json.dumps(prediction.tolist())))
    ...
    if args.viz_output is not None:
        ...
        coord_file2 = args.viz_video.replace(".mp4", "/3d_frame_coordinates.json")
